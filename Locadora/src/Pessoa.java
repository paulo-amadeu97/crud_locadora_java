...
public class Pessoa {
    ...
    private HashMap<String, Object> endereco = new HashMap<String, Object>();
    ...
    public Pessoa(String nome, int cep, String rua, int numero, String bairro, String cidade, String estado, int mesNascimento, int diaNascimento, int anoNascimento, String email, long celular) {
        if (nome == null || dataNascimento == null) {
            throw new NullPointerException("Nome e/ou data de nascimento são de preenchimento obrigatório");
        } else {
            this.nome = nome;
